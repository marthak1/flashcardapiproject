 ...
 * 
 * @PostMapping
 * public ResponseEntity<Flashcard> createFlashcard(@RequestBody Flashcard
 * flashcard) {
 * try {
 ...
 * "application/json")
 * public Flashcard updateFlashcard(@PathVariable Long id, @RequestBody
